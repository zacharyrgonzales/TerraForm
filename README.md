...
The ```terraform plan``` command is used to create an execution plan. Terraform performs a refresh, unless explicitly disabled, and then determines what actions are necessary to achieve the desired state specified in the configuration files. More details in the [link provided](https://www.terraform.io/docs/commands/plan.html#usage)
...
The ```terraform apply```command is used to apply the changes required to reach the desired state of the configuration, or the pre-determined set of actions generated by a terraform plan execution plan. More details in the [link provided](https://www.terraform.io/docs/commands/apply.html#usage)
